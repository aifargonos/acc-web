...
def _parse_line(string, data):
	...
	# TODO: do not substitute here, let logging do it!
...
@LOG
def import_from_file(input_file, account, dont_save=False):
	
	input_wrap = io.TextIOWrapper(input_file, encoding=DEFAULT_ENCODING)
